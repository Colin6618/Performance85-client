...
const PerformanceCardIconWrapper = styled.div<{ isOpen?: boolean }>`
  position: absolute;
  top: 15px;
  right: 15px;
...
export const PerformanceCardIcon: React.FC<{ isOpen: boolean }> = ({ isOpen }) => {
  return (
    
      <PerformanceCardIconWrapper isOpen={isOpen}>
      <CircleIcon
        size="25px"
        variant={isOpen ? 'success' : undefined}
        icon={isOpen ? 'exclamation' : ''}
      />
    </PerformanceCardIconWrapper>
